...
{
	return ksNew (
		50, keyNew ("system:/elektra/mountpoints/simple", KEY_END),
...
KeySet * set_backref (void)
{
	return ksNew (50, keyNew ("system:/elektra/mountpoints/backref", KEY_END),
		      ...
		      keyNew ("system:/elektra/mountpoints/backref/errorplugins/\\#1#" KDB_DEFAULT_STORAGE "#" KDB_DEFAULT_STORAGE "#",
			      KEY_VALUE, "introduce reference", KEY_END),
		      keyNew ("system:/elektra/mountpoints/backref/errorplugins/\\#1#" KDB_DEFAULT_STORAGE "#" KDB_DEFAULT_STORAGE
			      "#/config",
			      KEY_END),
		      keyNew ("system:/elektra/mountpoints/backref/errorplugins/\\#1#" KDB_DEFAULT_STORAGE "#" KDB_DEFAULT_STORAGE
		      ...
		      keyNew ("system:/elektra/mountpoints/backref/setplugins/\\#1#" KDB_DEFAULT_STORAGE, KEY_VALUE,
			      "reference to other default", KEY_END),
		      KS_END);
}
