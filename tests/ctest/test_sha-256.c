...
static void string_test(const char input[], const char output[])
{
	...
	succeed_if_fmt(strcmp(hash_string, output) == 0, "calculated sha-256 hash %s did not match expected result %s", hash_string, output);
}
...
static void test_streaming_aware_of_order (void) {
	...
	const struct string_vector vector1 = {
		"key = value", "f7c496f5894d24805efd2e40dc78bd31f57c07c900320c6426b4ddaa5da31d25"
	};
	const struct string_vector vector2 = {
		"keyvalue = ", "610ed9b80c58e2585d0ad426b4662c4d187c36dd64f093f17e99fc0b089630c2"
	};
