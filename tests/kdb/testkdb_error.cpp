...
TEST_F (Error, Simple)
{
	...
	ks.append (Key ("system" + testRoot + "key", KEY_META, "trigger/error", "C01400", KEY_END));
...
TEST_F (Error, CSimple)
{
	...
	ksAppendKey (ks, keyNew (("system" + testRoot + "key").c_str (), KEY_META, "trigger/error", "C01400", KEY_END));
