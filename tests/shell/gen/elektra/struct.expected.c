...
Elektra * loadConfiguration (ElektraError ** error)
{
	...
	keyNew ("spec/tests/script/gen/elektra/struct/person/_", KEY_META, "default", "", KEY_META, "gen/struct/type", "Person", KEY_META, "type", "struct", KEY_END),
