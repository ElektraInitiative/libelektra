...
{
	KeySet * defaults = ksNew (9,
	keyNew ("spec/tests/script/gen/elektra/struct/elektra/specload", KEY_META, "default", "0", KEY_META, "opt",
...
;
	...
	if (elektraGetBoolean (e, "spec/tests/script/gen/elektra/struct/elektra/specload"))
	{
		elektraClose (e);
		return specloadSend ();
	}
