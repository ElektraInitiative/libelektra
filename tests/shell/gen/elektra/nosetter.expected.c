...
/**
 * Initializes an instance of Elektra for the application '/tests/script/gen/elektra/nosetter'.
 *
...
;
	...
	Elektra * e = elektraOpen ("/tests/script/gen/elektra/nosetter", defaults, contract, error);
...
void specloadCheck (int argc, const char ** argv)
{
	...
	Key * parentKey = keyNew ("spec/tests/script/gen/elektra/nosetter", KEY_META, "system/elektra/quickdump/noparent", "", KEY_END);
