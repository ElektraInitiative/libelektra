...
int loadConfiguration (Elektra ** elektra, ElektraError ** error)
{
	...
	keyNew ("spec/tests/script/gen/elektra/empty/elektra/specload", KEY_META, "default", "0", KEY_META, "opt",
...
;
	...
	if (elektraGetBoolean (e, "spec/tests/script/gen/elektra/empty/elektra/specload"))
	{
		elektraClose (e);
		return specloadSend ();
	}
