...
;
	...
	Elektra * e = elektraOpen ("/tests/script/gen/elektra/enum", defaults, contract, error);
...
void specloadCheck (int argc, const char ** argv)
{
	...
	Key * parentKey = keyNew ("spec/tests/script/gen/elektra/enum", KEY_META, "system/elektra/quickdump/noparent", "", KEY_END);
