...
static KeySet * embeddedSpec (void)
{
	return ksNew (6, keyNew ("/", KEY_META, "mountpoint", "tests_gen_elektra_simple.ini", KEY_END),
		      ...
		      keyNew ("/print", KEY_META, "default", "0", KEY_META, "description", "enable/disable printing", KEY_META, "opt", "p",
			      KEY_META, "opt/arg", "none", KEY_META, "opt/help", "enable printing", KEY_META, "type", "boolean", KEY_END),
		      KS_END);
	;
}

static const char * helpFallback =
	"Usage: tests_script_gen_highlevel_simple [OPTION...]\n\nOPTIONS\n  --help                      Print this help message\n  -p      "
	"                    enable printing\n";
