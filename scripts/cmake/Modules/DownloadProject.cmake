...
function (download_project)
	...
	set (
		...
		DOWNLOAD_DIR
		SOURCE_DIR
		BINARY_DIR # Prevent the following from being passed through
		CONFIGURE_COMMAND
		BUILD_COMMAND
		INSTALL_COMMAND
		TEST_COMMAND)
	...
	# Set up where we will put our temporary CMakeLists.txt file and also the base point below which the default source and binary dirs
	...
	set (
		${DL_ARGS_PROJ}_SOURCE_DIR
		"${DL_ARGS_SOURCE_DIR}"
		PARENT_SCOPE)
	set (
		${DL_ARGS_PROJ}_BINARY_DIR
		"${DL_ARGS_BINARY_DIR}"
		PARENT_SCOPE)

	# The way that CLion manages multiple configurations, it causes a copy of the CMakeCache.txt to be copied across due to it not
	...
	# Create and build a separate CMake project to carry out the download. If we've already previously done these steps, they will not
