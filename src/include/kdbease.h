...
elektraKeyFlags keyCompareMeta (const Key * key1, const Key * key2);
...
kdb_boolean_t calculateSpecificationToken  (char hash_string[65], KeySet * inputKs, KeySet * fullKs);
