...
#include <kdberrors.h> // TODO: Generate separate file for the high level API. Do not include any "low level" kdb headers.

typedef struct _ElektraError ElektraError;

/*
typedef enum {
    // Generated by exporterrors.cpp. See kdberrors.h.
} ElektraErrorCode;
*/
