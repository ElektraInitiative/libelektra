...
#define ELEKTRA_SET_BY_STRING_SIGNATURE(Type, typeName) void ELEKTRA_SET_BY_STRING(typeName)(Elektra * elektra, const char * keyName, Type value, ElektraError ** error)
...
#define elektraGetString(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(String), \
    ELEKTRA_TAG(String): ELEKTRA_GET_BY_TAG(String) \
    )(elektra, keyOrTag)

#define elektraGetBoolean(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(Boolean), \
    ELEKTRA_TAG(Boolean): ELEKTRA_GET_BY_TAG(Boolean) \
    )(elektra, keyOrTag)

#define elektraGetChar(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(Char), \
    ELEKTRA_TAG(Char): ELEKTRA_GET_BY_TAG(Char) \
    )(elektra, keyOrTag)

#define elektraGetOctet(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(Octet), \
    ELEKTRA_TAG(Octet): ELEKTRA_GET_BY_TAG(Octet) \
    )(elektra, keyOrTag)

#define elektraGetShort(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(Short), \
    ELEKTRA_TAG(Short): ELEKTRA_GET_BY_TAG(Short) \
    )(elektra, keyOrTag)

#define elektraGetUnsignedShort(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(UnsignedShort), \
    ELEKTRA_TAG(UnsignedShort): ELEKTRA_GET_BY_TAG(UnsignedShort) \
    )(elektra, keyOrTag)

#define elektraGetLong(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(Long), \
    ELEKTRA_TAG(Long): ELEKTRA_GET_BY_TAG(Long) \
    )(elektra, keyOrTag)

#define elektraGetUnsignedLong(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(UnsignedLong), \
    ELEKTRA_TAG(UnsignedLong): ELEKTRA_GET_BY_TAG(UnsignedLong) \
    )(elektra, keyOrTag)

#define elektraGetLongLong(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(LongLong), \
    ELEKTRA_TAG(LongLong): ELEKTRA_GET_BY_TAG(LongLong) \
    )(elektra, keyOrTag)

#define elektraGetUnsignedLongLong(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(UnsignedLongLong), \
    ELEKTRA_TAG(UnsignedLongLong): ELEKTRA_GET_BY_TAG(UnsignedLongLong) \
    )(elektra, keyOrTag)

#define elektraGetFloat(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(Float), \
    ELEKTRA_TAG(Float): ELEKTRA_GET_BY_TAG(Float) \
    )(elektra, keyOrTag)

#define elektraGetDouble(elektra, keyOrTag) _Generic((keyOrTag), \
    char *: ELEKTRA_GET_BY_STRING(Double), \
    ELEKTRA_TAG(Double): ELEKTRA_GET_BY_TAG(Double) \
    )(elektra, keyOrTag)

#define elektraGetLongDouble(elektra, keyOrTag) _Generic((keyOrTag), \
