...
// clang-format off
typedef enum {
	GELEKTRA_KEY_FLAGS          = ELEKTRA_KEY_FLAGS,
	GELEKTRA_KEY_NAME           = ELEKTRA_KEY_NAME,
	GELEKTRA_KEY_VALUE          = ELEKTRA_KEY_VALUE,
	GELEKTRA_KEY_COMMENT        = ELEKTRA_KEY_COMMENT,
	GELEKTRA_KEY_BINARY         = ELEKTRA_KEY_BINARY,
	GELEKTRA_KEY_SIZE           = ELEKTRA_KEY_SIZE,
	GELEKTRA_KEY_FUNC           = ELEKTRA_KEY_FUNC,
	GELEKTRA_KEY_META           = ELEKTRA_KEY_META,
	GELEKTRA_KEY_NULL           = ELEKTRA_KEY_NULL
} GElektraKeySwitch;
