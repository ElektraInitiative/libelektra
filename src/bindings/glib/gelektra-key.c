...
static void gelektra_key_set_property(GObject *object, guint property_id,
	const GValue *value ELEKTRA_UNUSED, GParamSpec *pspec)
{
	G_OBJECT_WARN_INVALID_PROPERTY_ID(object, property_id, pspec);
}

static void gelektra_key_get_property(GObject *object, guint property_id,
 ...
 */
gssize gelektra_key_setbinary(GElektraKey *key, const void *data,
	gsize size)
{
...
/* meta data */
gssize gelektra_key_setmeta(GElektraKey *key, const gchar *name,
	const gchar *value)
{
...
gint gelektra_key_copymeta(const GElektraKey *key, GElektraKey *dest,
	const gchar *name)
{
...
gboolean gelektra_key_isbeloworsame(const GElektraKey *key,
	const GElektraKey *other)
{
	return keyIsBelowOrSame(other->key, key->key);
}

gboolean gelektra_key_isdirectbelow(const GElektraKey *key,
	const GElektraKey *other)
{
