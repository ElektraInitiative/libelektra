...
`go get goelektra.libelektra.org/kdb`
...
The documentation can be viewed on [godoc.org](https://godoc.org/goelektra.libelektra.org/kdb).
...
### Cannot find package "goelektra.libelektra.org/kdb"
