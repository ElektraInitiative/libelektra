...
public class SortedMetadata {
    private static final Map<String, String> valuesByKeyName = ofEntries(
            entry("/infos", "Sorted Java Plugin, loaded by process plugin"),
            entry("/infos/author", "Markus Bointner <e11808221@student.tuwien.ac.at>, Philipp Leeb <e11808219@student.tuwien.ac.at>"),
            ...
            entry("/infos/description", "Enforces a given order of array elements based on a custom defined key or primitive values"),
