...
public class KeySet extends AbstractSet<Key> implements SortedSet<Key>
{
	...
	@Nonnull public static KeySet create (int allocationHint, Key... keys)
	{
		...
		return checkPointer (Elektra.INSTANCE.ksNew (allocationHint >= args.length ? allocationHint : args.length, args),
				     KeySet::new, KeySetException::new);
	}
	 ...
	 * @return This {@link KeySet}, enabling a fluent interface
	 * @throws IllegalStateException    if this {@link KeySet} or the specified
	 *                                  {@code key} has already been released
	 * @throws IllegalArgumentException if {@code key} is {@code null}
	 * @throws KeySetException          if appending the {@code key} failed because
	 ...
	 *                                  {@code source} has already been released
	 * @throws IllegalArgumentException if {@code source} is {@code null}
	 * @throws KeySetException          if appending the {@code source} failed
	 *                                  because of allocation problems
	 */
	 ...
	 * @throws KeySetException          if {@code cutpoint} is missing a key name or
	...
	@Nonnull public KeySet cut (Key cutpoint)
	{
		...
		return checkPointer (Elektra.INSTANCE.ksCut (getPointer (), cutpoint.getPointer ()), KeySet::new, KeySetException::new);
	}
	...
	{
		return checkPointer (Elektra.INSTANCE.elektraKsPopAtCursor (getPointer (), cursor), Key::new,
	...
	{
		return checkPointer (Elektra.INSTANCE.ksAtCursor (getPointer (), cursor), Key::new, IndexOutOfBoundsException::new);
	}
	 ...
	 * @throws IllegalStateException    if {@link KeySet} or {@code key} has already
	 *                                  been released
	 * @throws IllegalArgumentException if {@code key} was not found in this
	 *                                  {@link KeySet}
	 */
	...
	/**
	 * Binary search in the native key set resulting in the index of the key, if it
	 * is already contained in the key set or the index where the {@code key} would
	 * be inserted.
	 *
	 * @param key Key to look for
	 * @return Index of the {@code key} in this {@link KeySet} (&gt;=0) or if
	 *         {@code key} was not found in this {@link KeySet}, the index of the
	 *         position where the {@code key} would be inserted (&lt;0). To get the
	 *         correct insertion index calculate {@code result * -1 - 1}
	 *
	 * @throws IllegalStateException if {@link KeySet} or {@code key} has already
	 *                               been released
	 */
	...
	{
		return Elektra.INSTANCE.ksSearchInternal (this.getPointer (), key.getPointer ());
	}
	 ...
	 *
	 * @throws IllegalStateException if this {@link KeySet} has already been
	 *                               released or the passed {@link Object o} is a
	 *                               {@link Key} that has already been released
	 * @throws NullPointerException  if the specified element {@code o} is
	 *                               {@code null}
	 * @see #lookup(Key)
	 */
	 ...
	 * @throws KeySetException       if inserting the {@code key} failed because of
	 *                               allocation problems
	 * @see #append(Key)
	 */
	@Override public boolean add (Key e)
	{
		if (contains (e))
		{
			return false;
	...
	@Override public boolean remove (Object o)
	{
		...
		if (o instanceof ReadableKey)
		{
			return Elektra.INSTANCE.ksLookup (getPointer (), ((ReadableKey) o).getPointer (), Elektra.KDB_O_POP) != null;
		}
		return false;
	}
	 ...
	 * @throws IllegalStateException if this {@link KeySet} has already been
	 *                               released
	 * @throws NullPointerException  if the specified collection is {@code null} or
	 ...
	 * {@inheritDoc}
	 *
	 * @throws IllegalStateException if this {@link KeySet} or any {@link Key}
	 *                               contained in the specified collection {@code c}
	 ...
	 *                               allocation problems
	 */
	@Override public boolean addAll (Collection<? extends Key> c)
	{
	 ...
	 * {@inheritDoc}
	 *
	 * @implSpec Returns {@code null} because natural ordering of keys is used
	 *           ({@link ReadableKey} implements {@link Comparable})
	 * @throws IllegalStateException if this {@link KeySet} has already been
	 *                               released
	 */
	@Override public Comparator<? super Key> comparator ()
	{
		return null;
	}
	 ...
	 */
	@Override public SortedSet<Key> subSet (Key fromElement, Key toElement)
	{
	 ...
	 * @throws IllegalArgumentException {@inheritDoc}
	 */
	@Override public SortedSet<Key> headSet (Key toElement)
	{
	 ...
	 * @throws IllegalArgumentException {@inheritDoc}
	 */
	@Override public SortedSet<Key> tailSet (Key fromElement)
	{
	...
	{
		return checkPointer (Elektra.INSTANCE.ksHead (getPointer ()), Key::new, NoSuchElementException::new);
	}
	...
	{
		return checkPointer (Elektra.INSTANCE.ksTail (getPointer ()), Key::new, NoSuchElementException::new);
	}

	/**
	 * View backed by a {@link KeySet}. Changes in the backing {@link KeySet} are
	 * reflected in this view and vice versa. The range of this view is defined by
	 * an inclusive start element and an inclusive end element.
	 */
	private static class KeySetView extends AbstractSet<Key> implements SortedSet<Key>
	{
		...
		/**
		 * Inclusive start element for this view on the backing {@link KeySet keySet}.
		 * {@link Optional#empty()} if this view does not have a lower bound.
		 */
		private final Optional<Key> oFromElement;

		/**
		 * Exclusive end element for this view on the backing {@link KeySet keySet}.
		 * {@link Optional#empty()} if this view does not have an upper bound.
		 */
		 ...
		 * @throws IllegalStateException if the {@link KeySet} backing this
		 *                               {@link KeySetView} or the {@link Key}
		 *                               signifying this view's lower bound has already
		 *                               been released
		 */
		 ...
		 * @throws IllegalStateException if the {@link KeySet} backing this
		 *                               {@link KeySetView} or the {@link Key}
		 *                               signifying this view's upper bound has already
		 *                               been released
		 */
		private int getUpperBound ()
		{
			return oToElement.map (keySet::searchForIndexOf).map (i -> i < 0 ? i * -1 : i).orElseGet (keySet::size);
		}
		 ...
		 *
		 * @throws IllegalStateException if the {@link KeySet} backing this
		 *                               {@link KeySetView} or any {@link Key}
		 *                               signifying this view's lower or upper bound has
		 ...
		 *                               {@link KeySetView} or any {@link Key}
		 *                               signifying this view's lower or upper bound has
		 *                               already been released or the passed
		 *                               {@link Object o} is a {@link Key} that has
		 *                               already been released
		 * @throws NullPointerException  if the specified element {@code o} is
		 *                               {@code null}
		 */
		 ...
		 * {@inheritDoc}
		 *
		 * @return New {@link KeySetIterator} backed by the {@link KeySet} backing this
		 *         {@link KeySetView}
		 * @throws IllegalStateException if any {@link Key} signifying this view's lower
		 *                               or upper bound has already been released
		 */
		@Override public Iterator<Key> iterator ()
		{
		 ...
		 *
		 * @throws IllegalStateException    if the {@link KeySet} backing this
		 *                                  {@link KeySetView}, the specified
		 *                                  {@code key} or any {@link Key} signifying
		 *                                  this view's lower or upper bound has already
		 *                                  been released
		 * @throws NullPointerException     if {@code key} is {@code null}
		 * @throws IllegalArgumentException if {@code key} is violating the lower or
		 *                                  upper bound of this {@link KeySetView}
		 * @throws KeySetException          if inserting the {@code key} failed because
		 *                                  of allocation problems
		 */
		@Override public boolean add (Key e)
		{
			...
			// range of this view
			if (insertPosition >= 0 && (!hasLowerBound () || insertPosition >= getLowerBound ()) &&
			...
			if ((hasLowerBound () && insertPosition < getLowerBound ()) ||
			    (hasUpperBound () && (e.equals (oToElement.get ()) || insertPosition > getUpperBound ())))
			{
				throw new IllegalArgumentException ();
			}
		 ...
		 *
		 * @throws IllegalStateException if the {@link KeySet} backing this
		 *                               {@link KeySetView} has already been released
		 */
		@Override public boolean remove (Object o)
		{
			requireNonNull (o);
			if (o instanceof ReadableKey)
			{
				...
				if (keyIndex >= 0 && (!hasLowerBound () || keyIndex >= getLowerBound ()) &&
				    (!hasUpperBound () || keyIndex < getUpperBound ()))
				{
					return Elektra.INSTANCE.ksLookup (keySet.getPointer (), ((ReadableKey) o).getPointer (),
									  Elektra.KDB_O_POP) != null;
				}
			}
			return false;
		}
		 ...
		 * @throws IllegalStateException    if the {@link KeySet} backing this
		 *                                  {@link KeySetView} or any {@link Key}
		 *                                  signifying this view's lower or upper bound
		 *                                  has already been released
		 * @throws IllegalArgumentException if {@code key} is violating the lower or
		 *                                  upper bound of this {@link KeySetView}
		...
		@Override public SortedSet<Key> subSet (Key fromElement, Key toElement)
		{
			...
			if (fromElementIndex > toElementIndex || (hasLowerBound () && fromElementIndex <= getLowerBound ()) ||
		 ...
		 * @see Key#release()
		 */
		@Override public Key first ()
		{
			return checkPointer (Elektra.INSTANCE.ksAtCursor (keySet.getPointer (), getLowerBound ()), Key::new,
		 ...
		 * @see Key#release()
		 */
		@Override public Key last ()
		{
			return checkPointer (Elektra.INSTANCE.ksAtCursor (keySet.getPointer (), getUpperBound () - 1), Key::new,
					     NoSuchElementException::new);
		}
	}
}
