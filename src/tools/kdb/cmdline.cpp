...
: synopsis (command->getSynopsis ()), helpText (), invalidOpt (false),
  ...
  inputFile (""), null (), first (true), second (true), third (true), withRecommends (false), all (), format (KDB_STORAGE),
  plugins (""), globalPlugins ("spec"), pluginsConfig (""), color ("auto"), ns (""), editor (), bookmarks (), profile ("current"),
