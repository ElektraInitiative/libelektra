...
int MountOdbcCommand::execute (Cmdline const &cl)
{
	...
	keyDataSourceName.setString ("Pelektra");
	keyUserName.setString ("flo");
	keyPassword.setString ("elektra");
	keyTableName.setString ("elektra");
	keyKeyColName.setString ("key");
	keyValColName.setString ("val");
	keyMetaTableName.setString ("elektrameta");
	keyMetaTableKeyColName.setString ("key");
	keyMetaTableMetaKeyColName.setString ("metakey");
	keyMetaTableMetaValColName.setString ("metaval");
