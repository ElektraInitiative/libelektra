...
TEST (kdbrestServiceConfigengineTest, TransformKeysetToJsonValue)
{
	...
	kdb::Key k1 (conf_root + "/nested/object/var", KEY_VALUE, "simple string", KEY_END);
	kdb::Key k2 (conf_root + "/nested/object/var2", KEY_VALUE, "12345", KEY_END);
	kdb::Key k3 (conf_root + "/nested/object/var3", KEY_VALUE, "1", KEY_END);
	kdb::Key k4 (conf_root + "/nested/object/var4", KEY_VALUE, "0", KEY_END);
	kdb::Key k5 (conf_root + "/object/array/#0", KEY_VALUE, "first element", KEY_END);
	kdb::Key k6 (conf_root + "/object/array/#1", KEY_VALUE, "second element", KEY_END);
	kdb::Key k7 (conf_root + "/object/array2/#0/var", KEY_VALUE, "first var", KEY_END);
	kdb::Key k8 (conf_root + "/object/array2/#0/var2", KEY_VALUE, "second var", KEY_END);
	kdb::Key k9 (conf_root + "/object/array2/#0/var3", KEY_VALUE, "third var", KEY_END);
	kdb::Key k10 (conf_root + "/object/array2/#1/var", KEY_VALUE, "first var", KEY_END);
	kdb::Key k11 (conf_root + "/object/array2/#2/var", KEY_VALUE, "first var", KEY_END);
	kdb::Key k12 (conf_root + "/object/array2/#2/var2", KEY_VALUE, "54321", KEY_END);
	kdb::Key k13 (conf_root + "/object/array3/#0/var/#0", KEY_VALUE, "arr0-in-arr0", KEY_END);
	kdb::Key k14 (conf_root + "/object/array3/#0/var/#1", KEY_VALUE, "arr1-in-arr0", KEY_END);
	kdb::Key k15 (conf_root + "/object/array3/#1/var/#0", KEY_VALUE, "arr0-in-arr1", KEY_END);
