			...
			TabView {
				...
				Tab {
					...
					TextArea {
						...
						text: "<html>" +
							  "<style type=\"text/css\"></style>" +
							  "<p><a href=\"" + oxygenUrl + "\">Oxygen Icons</a> are used under <a href=\"" + ccUrl + "\">CC BY-SA 3.0</a></p>" +
							  "<h3 style=\"text-align: center;\">Creative Commons Legal Code</h3>" +
							  "<p style=\"text-align: center;\">Attribution-ShareAlike 3.0 Unported</p>" +
