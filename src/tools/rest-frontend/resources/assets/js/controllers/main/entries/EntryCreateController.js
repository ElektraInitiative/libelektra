(function() {
    ...
    EntryCreateController.$inject = [
        '$scope', 'Logger', 'EntryService', '$state', 'Notification', 'formats'
    ];

    function EntryCreateController($scope, Logger, EntryService, $state, Notification, formats) {
