...
TEST (MountBackendBuilder, parsePluginArguments)
{
	...
	EXPECT_EQ (KeySet (5, *Key ("user:/a", ELEKTRA_KEY_VALUE, "5", ELEKTRA_KEY_END), ELEKTRA_KS_END), parsePluginArguments ("a=5"));
	EXPECT_EQ (KeySet (5, *Key ("user:/", ELEKTRA_KEY_END), ELEKTRA_KS_END), parsePluginArguments ("="));
	EXPECT_EQ (KeySet (5, *Key ("user:/a", ELEKTRA_KEY_VALUE, "5", ELEKTRA_KEY_END), *Key ("user:/ax", ELEKTRA_KEY_VALUE, "a", ELEKTRA_KEY_END),
			   *Key ("user:/ax/bx", ELEKTRA_KEY_VALUE, "8", ELEKTRA_KEY_END), ELEKTRA_KS_END),
		   parsePluginArguments ("a=5,ax=a,ax/bx=8"));
	EXPECT_EQ (KeySet (5, *Key ("user:/", ELEKTRA_KEY_VALUE, "5", ELEKTRA_KEY_END), *Key ("user:/ax", ELEKTRA_KEY_END, ELEKTRA_KEY_END),
			   *Key ("user:/ax/bx", ELEKTRA_KEY_VALUE, "8", ELEKTRA_KEY_END), ELEKTRA_KS_END),
	...
	EXPECT_EQ (KeySet (5, *Key ("user:/", ELEKTRA_KEY_VALUE, "5", ELEKTRA_KEY_END), *Key ("user:/ax", ELEKTRA_KEY_END, ELEKTRA_KEY_END),
			   *Key ("user:/ax\\/bx", ELEKTRA_KEY_VALUE, "8", ELEKTRA_KEY_END), ELEKTRA_KS_END),
		   parsePluginArguments ("=5,ax=,ax\\/bx=8"));
	EXPECT_EQ (KeySet (5, *Key ("user:/", ELEKTRA_KEY_END), *Key ("user:/ax", ELEKTRA_KEY_END, ELEKTRA_KEY_END),
			   *Key ("user:/ax\\/bx", ELEKTRA_KEY_VALUE, "8", ELEKTRA_KEY_END), ELEKTRA_KS_END),
...
TEST (MountBackendBuilder, parseArguments)
{
	...
	psv1.push_back (PluginSpec ("a", KeySet (5, *Key ("user:/a", ELEKTRA_KEY_VALUE, "5", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
...
TEST (MountBackendBuilder, parseVectorArguments)
{
	...
	PluginSpecVector psv1;
	psv1.push_back (
		PluginSpec ("a", KeySet (5, *Key ("user:/a", ELEKTRA_KEY_VALUE, "5", ELEKTRA_KEY_END), *Key ("user:/b", ELEKTRA_KEY_VALUE, "3", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	psv1.push_back (PluginSpec ("b"));
	psv1.push_back (
		PluginSpec ("c", KeySet (5, *Key ("user:/a", ELEKTRA_KEY_VALUE, "5", ELEKTRA_KEY_END), *Key ("user:/b", ELEKTRA_KEY_VALUE, "3", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
...
TEST (MountBackendBuilder, parseArgumentsDoubleOccur)
{
	...
	using namespace kdb::tools;
	PluginSpecVector psv1;
	psv1.push_back (PluginSpec ("a", 0, KeySet (5, *Key ("user:/a", ELEKTRA_KEY_VALUE, "5", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	psv1.push_back (PluginSpec ("b"));
	psv1.push_back (PluginSpec ("c"));
	psv1.push_back (PluginSpec ("a", 1, KeySet (5, *Key ("user:/b", ELEKTRA_KEY_VALUE, "c", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
...
TEST (MountBackendBuilder, parseArgumentsRef)
{
	...
	using namespace kdb::tools;
	PluginSpecVector psv1;
	psv1.push_back (PluginSpec ("a", "mya", KeySet (5, *Key ("user:/a", ELEKTRA_KEY_VALUE, "5", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	psv1.push_back (PluginSpec ("b", "myb"));
	psv1.push_back (PluginSpec ("c", "myc"));
	psv1.push_back (PluginSpec ("a", "othera", KeySet (5, *Key ("user:/b", ELEKTRA_KEY_VALUE, "c", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
...
TEST (MountBackendBuilder, parseArgumentsProvider)
{
	...
	using namespace kdb::tools;
	PluginSpecVector psv1;
	psv1.push_back (PluginSpec ("augeas", "aaa", KeySet (5, *Key ("user:/a", ELEKTRA_KEY_VALUE, "5", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	psv1.push_back (PluginSpec ("logging", "logg"));
	psv1.push_back (PluginSpec ("code", "nee", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "-", ELEKTRA_KEY_END), ELEKTRA_KS_END))),
		psv1.push_back (PluginSpec ("hexcode", "hexcode", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "%", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	...
	psv3.push_back (PluginSpec ("augeas", "aaa", KeySet (5, *Key ("user:/a", ELEKTRA_KEY_VALUE, "5", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	psv3.push_back (PluginSpec ("syslog", "logg"));
	psv3.push_back (PluginSpec ("ccode", "nee", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "-", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	psv3.push_back (PluginSpec ("hexcode", "hexcode", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "%", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
...
TEST (MountBackendBuilder, parseArgumentsSameProvider)
{
	...
	psv1.push_back (PluginSpec ("code", "a3", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "%", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	psv1.push_back (PluginSpec ("code", "a4", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "-", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	...
	psv3.push_back (PluginSpec ("ccode", "a3", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "%", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	psv3.push_back (PluginSpec ("ccode", "a4", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "-", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
...
TEST (MountBackendBuilder, parseArgumentsSameProviderAgain)
{
	...
	psv1.push_back (PluginSpec ("code", "same3", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "%", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	psv1.push_back (PluginSpec ("code", "same4", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "-", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	...
	psv3.push_back (PluginSpec ("ccode", "same3", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "%", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	psv3.push_back (PluginSpec ("ccode", "same4", KeySet (5, *Key ("user:/escape", ELEKTRA_KEY_VALUE, "-", ELEKTRA_KEY_END), ELEKTRA_KS_END)));
	CMP_PSV (psv3, psv4);
}
