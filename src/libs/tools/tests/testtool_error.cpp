...
TEST (Error, TestWarnings)
{
	...
	kdb::tools::errors::OutOfMemoryWarning outOfMemoryWarning ("outOfMemoryWarningReason",
								   ...
								   "outOfMemoryWarningFile",
								   "outOfMemoryWarningMountPoint",
	...
	kdb::tools::errors::InstallationWarning installationWarning ("installationWarningReason",
								     ...
								     "installationWarningFile",
								     "installationWarningMountPoint",
	...
	kdb::tools::errors::InterfaceWarning interfaceWarning ("interfaceWarningReason",
							       ...
							       "interfaceWarningFile",
							       "interfaceWarningMountPoint",
							       "interfaceWarningConfigFile", 2);
	...
	kdb::tools::errors::PluginMisbehaviorWarning pluginMisbehaviorWarning ("pluginMisbehaviorWarningReason",
									       ...
									       "pluginMisbehaviorWarningFile",
									       "pluginMisbehaviorWarningMountPoint",
									       "pluginMisbehaviorWarningConfigFile", 3);
	...
	kdb::tools::errors::ConflictingStateWarning conflictingStateWarning ("conflictingStateWarningReason",
									     ...
									     "conflictingStateWarningFile",
									     "conflictingStateWarningMountPoint",
									     "conflictingStateWarningConfigFile",4);
	...
	kdb::tools::errors::ValidationSyntacticWarning validationSyntacticWarning ("validationSyntacticWarningReason",
										   ...
										   "validationSyntacticWarningFile",
										   "validationSyntacticMountPoint",
										   "validationSyntacticWarningConfigFile", 5);
	...
	kdb::tools::errors::ValidationSemanticWarning validationSemanticWarning ("validationSemanticWarningReason",
										 ...
										 "validationSemanticWarningFile",
										 "validationSemanticWarningMountPoint",
										 "validationSemanticWarningConfigFile", 6);
...
TEST (Error, TestErrors)
{
	...
	kdb::tools::errors::ResourceError resourceError ("resourceErrorReason",
							 "resourceErrorModule",
							 "resourceErrorFile",
							 "resourceErrorMountPoint",
							 "resourceErrorConfigFile", 0);
	...
	kdb::tools::errors::OutOfMemoryError outOfMemoryError ("outOfMemoryErrorReason",
							       ...
							       "outOfMemoryErrorFile",
							       "outOfMemoryErrorMountPoint",
							       "outOfMemoryErrorConfigFile", 1);
	...
	kdb::tools::errors::InstallationError installationError ("installationErrorReason",
								 ...
								 "installationErrorFile",
								 "installationErrorMountPoint",
	...
	kdb::tools::errors::InternalError internalError ("internalErrorReason",
							 "internalErrorModule",
							 "internalErrorFile",
							 "internalErrorMountPoint",
							 "internalErrorConfigFile", 999);
	...
	kdb::tools::errors::PluginMisbehaviorError pluginMisbehaviorError ("pluginMisbehaviorErrorReason",
									       ...
									       "pluginMisbehaviorErrorFile",
									   "pluginMisbehaviorErrorMountPoint",
	...
	kdb::tools::errors::ConflictingStateError conflictingStateError ("conflictingStateErrorReason",
									     ...
									     "conflictingStateErrorFile",
									 "conflictingStateErrorMountPoint",
	...
	kdb::tools::errors::ValidationSyntacticError validationSyntacticError ("validationSyntacticErrorReason",
										   ...
										   "validationSyntacticErrorFile",
									       "validationSyntacticErrorMountPoint",
									       "validationSyntacticErrorConfigFile", 5);
	...
	kdb::tools::errors::ValidationSemanticError validationSemanticError ("validationSemanticErrorReason",
										 ...
										 "validationSemanticErrorFile",
									     "validationSemanticErrorMountPoint",
									     "validationSemanticErrorConfigFile", 6);
...
TEST (Error, ErrWarn)
{
	...
	kdb::tools::errors::PluginMisbehaviorError pmE ("pmeReason", "pmeModule", "pmeFile", "pmeMountPoint",
							"pmeConfigFile", 100);
	kdb::tools::errors::ConflictingStateWarning csW ("cswReason", "cswModule", "cswFile", "cswMountPoint",
							 "cswConfigFile", 101);
	kdb::tools::errors::InterfaceWarning ifW ("ifwReason", "ifwModule", "ifwFile", "ifwMountPoint",
						  "ifwConfigFile", 102);
...
TEST (Error, Equality)
{
	...
	kdb::tools::errors::InstallationWarning installationWarning ("Reason", "Module", "File", "MountPoint",
								     "ConfigFile", 42);
	kdb::tools::errors::InstallationWarning installationWarning2 ("Reason", "Module", "File", "MountPoint",
								      "ConfigFile", 42);
	kdb::tools::errors::InterfaceWarning interfaceWarning ("Reason", "Module", "File", "MountPoint",
							       "ConfigFile", 42);
	kdb::tools::errors::InstallationError installationError ("Reason", "Module", "File", "MountPoint",
								 "ConfigFile", 42);
	...
	kdb::tools::errors::InstallationError installationError1 ("Reason", "Module", "File", "MountPoint",
								  "ConfigFile", 42);
	kdb::tools::errors::ResourceError resourceError ("Reason", "Module", "File", "MountPoint",
							 "ConfigFile", 42);
