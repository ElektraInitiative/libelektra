...
{
	testOldMount ("/hello/hello", "/hello_hello");
}
TEST (Umount, SimilarOldNew2)
{
	testOldMount ("/hello/hello", "_hello_hello");
}
TEST (Umount, SimilarOldNew3)
{
	testOldMount ("/", "_");
}
TEST (Umount, SimilarOldNew4)
{
	testOldMount ("/", "/");
}
