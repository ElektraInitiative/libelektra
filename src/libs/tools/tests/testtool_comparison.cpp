...
{
	Key k1 = Key ("user:/test/config/key1", ELEKTRA_KEY_VALUE, "keyvalue", ELEKTRA_KEY_END);
	Key k2 = Key ("user:/test/config/key2", ELEKTRA_KEY_VALUE, "keyvalue", ELEKTRA_KEY_END);
...
{
	Key k1 = Key ("user:/test/config/key1", ELEKTRA_KEY_VALUE, "keyvalue1", ELEKTRA_KEY_END);
	Key k2 = Key ("user:/test/config/key2", ELEKTRA_KEY_VALUE, "keyvalue2", ELEKTRA_KEY_END);
...
{
	Key k1 = Key ("user:/test/config/key1", ELEKTRA_KEY_VALUE, "keyvalue1", ELEKTRA_KEY_END);
	Key k2 = Key ("user:/test/config/key2", ELEKTRA_KEY_VALUE, "keyvalue1", ELEKTRA_KEY_BINARY, ELEKTRA_KEY_END);
...
{
	Key k1 = Key ("user:/test/config/key1", ELEKTRA_KEY_VALUE, "keyvalue1", ELEKTRA_KEY_META, "testmeta", "testmetavalue1", ELEKTRA_KEY_END);
	Key k2 = Key ("user:/test/config/key2", ELEKTRA_KEY_VALUE, "keyvalue1", ELEKTRA_KEY_META, "testmeta", "testmetavalue1", ELEKTRA_KEY_END);
...
{
	Key k1 = Key ("user:/test/config/key1", ELEKTRA_KEY_VALUE, "keyvalue1", ELEKTRA_KEY_META, "testmeta", "testmetavalue1", ELEKTRA_KEY_END);
	Key k2 = Key ("user:/test/config/key2", ELEKTRA_KEY_VALUE, "keyvalue1", ELEKTRA_KEY_META, "testmeta", "testmetavalue2", ELEKTRA_KEY_END);
...
{
	Key k1 = Key ("user:/test/config/key1", ELEKTRA_KEY_VALUE, "keyvalue1", ELEKTRA_KEY_META, "testmeta", "testmetavalue1", ELEKTRA_KEY_END);
	Key k2 = Key ("user:/test/config/key2", ELEKTRA_KEY_VALUE, "keyvalue1", ELEKTRA_KEY_END);
