...
[decision document](/doc/decisions/5_partially_implemented/array.md) on this topic. Please note that the high level API does not support arrays with missing
