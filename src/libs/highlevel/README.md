...
use it in your source file, just include the main header with `#include <elektra/elektra.h>` at the top of your file.
...
You can find the complete list of the available functions for all supported value types in [elektra.h](/src/include/elektra/elektra.h)
