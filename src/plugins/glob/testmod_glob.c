...
void test_zeroMatchFlags()
{
	...
	succeed_if(strcmp ("testvalue1", keyValue (metaKey1)) == 0,
			"value of metakey testmetakey1 not correct");
	...
	succeed_if(strcmp ("testvalue1", keyValue (metaKey2)) == 0,
			"value of metakey testmetakey1 not correct");
