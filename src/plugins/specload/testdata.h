...
#define DEFAULT_SPEC ksNew (50, keyNew (PARENT_KEY "/mykey", ELEKTRA_KEY_META, "default", "7", ELEKTRA_KEY_END), ELEKTRA_KS_END)
...
#define NOPARENT_SPEC ksNew (50, keyNew ("/mykey", ELEKTRA_KEY_META, "default", "7", ELEKTRA_KEY_END), ELEKTRA_KS_END)
