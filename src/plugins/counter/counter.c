...
int elektraCounterGet(Plugin *handle ELEKTRA_UNUSED, KeySet *returned ELEKTRA_UNUSED, Key *parentKey ELEKTRA_UNUSED)
{
	if (!strcmp(keyName(parentKey), "system/elektra/modules/counter"))
	{
		...
		keyNew ("system/elektra/modules/counter",
			KEY_VALUE, "counter plugin waits for your orders", KEY_END),
		keyNew ("system/elektra/modules/counter/exports", KEY_END),
		keyNew ("system/elektra/modules/counter/exports/open",
			KEY_FUNC, elektraCounterOpen, KEY_END),
		keyNew ("system/elektra/modules/counter/exports/close",
			KEY_FUNC, elektraCounterClose, KEY_END),
		keyNew ("system/elektra/modules/counter/exports/get",
			KEY_FUNC, elektraCounterGet, KEY_END),
		keyNew ("system/elektra/modules/counter/exports/set",
			KEY_FUNC, elektraCounterSet, KEY_END),
		keyNew ("system/elektra/modules/counter/exports/error",
			KEY_FUNC, elektraCounterError, KEY_END),
#include ELEKTRA_README(counter)
		keyNew ("system/elektra/modules/counter/infos/version",
