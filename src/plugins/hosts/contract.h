...
elektraKeysetNew (30,
		elektraKeyNew ("system:/elektra/modules/hosts",
			ELEKTRA_KEY_VALUE, "hosts plugin waits for your orders", ELEKTRA_KEY_END),
		elektraKeyNew ("system:/elektra/modules/hosts/exports", ELEKTRA_KEY_END),
		elektraKeyNew ("system:/elektra/modules/hosts/exports/get",
			ELEKTRA_KEY_FUNC, elektraHostsGet,
			ELEKTRA_KEY_END),
		elektraKeyNew ("system:/elektra/modules/hosts/exports/set",
			ELEKTRA_KEY_FUNC, elektraHostsSet,
			ELEKTRA_KEY_END),
#include "readme_hosts.c"
		elektraKeyNew ("system:/elektra/modules/hosts/infos/version",
			ELEKTRA_KEY_VALUE, PLUGINVERSION,
			ELEKTRA_KEY_END),
		elektraKeyNew ("system:/elektra/modules/hosts/config", ELEKTRA_KEY_END),
		elektraKeyNew ("system:/elektra/modules/hosts/config/needs", ELEKTRA_KEY_END),
		elektraKeyNew ("system:/elektra/modules/hosts/config/needs/glob/set/#0",
			...
			ELEKTRA_KEY_END),
		elektraKeyNew ("system:/elektra/modules/hosts/config/needs/glob/set/#1",
			...
			ELEKTRA_KEY_END),
		elektraKeyNew ("system:/elektra/modules/hosts/config/needs/glob/set/#2",
				ELEKTRA_KEY_VALUE, "/ipv4/*/*",
				ELEKTRA_KEY_END),
		elektraKeyNew ("system:/elektra/modules/hosts/config/needs/glob/set/#3",
				ELEKTRA_KEY_VALUE, "/ipv6/*/*",
				ELEKTRA_KEY_END),
		elektraKeyNew ("system:/elektra/modules/hosts/config/needs/glob/set/#4",
			ELEKTRA_KEY_VALUE, "/*",
			ELEKTRA_KEY_META, "trigger/error", "162",
			ELEKTRA_KEY_END),
		elektraKeyNew ("system:/elektra/modules/hosts/config/needs/glob/set/#4/flags",
