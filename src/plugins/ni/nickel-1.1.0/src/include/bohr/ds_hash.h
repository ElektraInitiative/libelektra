...
typedef int (* Ds_hash_compare_fn)(const void * key, size_t key_size,
 ...
 */
Ds_HASH_INLINE Ds_hash_entry * Ds_NextHashEntry(
 ...
 */
Ds_HASH_INLINE Ds_hash_entry * Ds_InsertHashItem(
 ...
 */
Ds_HASH_INLINE int Ds_RemoveHashEntry(Ds_hash_table * restrict table,
                                      Ds_hash_entry * restrict entry)
{
   int found = 0;
   Ds_hash_entry * t;
 ...
 * compare().
 */
Ds_HASH_INLINE Ds_hash_entry * Ds_SearchHashTable(
   const Ds_hash_table * restrict table,
   const void * restrict key,
   size_t size,
   Ds_hash_t hash,
   Ds_hash_compare_fn compare)
{
   Ds_hash_entry * t;
