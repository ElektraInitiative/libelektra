...
#define _Ds_VECTOR_SYMBOL_CAT(symbol, suffix) \
                                         __Ds_VECTOR_SYMBOL_CAT(symbol, suffix)
#define _Ds_VECTOR_SYMBOL(symbol) \
                                _Ds_VECTOR_SYMBOL_CAT(symbol, Ds_VECTOR_SUFFIX)
...
#define Ds_VECTOR_INIT {NULL, 0, 0} //initializer
 ...
 * if it fails.
 */
Ds_VECTOR_INLINE int Ds_InsertVectorItems(
   Ds_vector * restrict v,
   const Ds_VECTOR_TYPE * restrict items,
 ...
 */
Ds_VECTOR_INLINE void Ds_RemoveVectorItems(Ds_vector * restrict v,
