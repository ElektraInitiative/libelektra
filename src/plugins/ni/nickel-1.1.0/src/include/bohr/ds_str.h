...
#define Ds_STR_INIT {NULL, 0, 0} //initializer
 ...
 * failure.
 */
Ds_STR_INLINE int Ds_StrCat(Ds_str * restrict dest,
                            const char * restrict source, int source_len)
{
   int new_size;
 ...
 */
Ds_STR_INLINE int Ds_StrCatVPrint(Ds_str * restrict dest,
 ...
 * va_list.
 */
Ds_STR_INLINE int Ds_StrCatPrint(Ds_str * restrict dest,
