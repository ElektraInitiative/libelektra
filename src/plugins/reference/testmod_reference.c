...
static void test_single_positive (void)
{
	...
	EXPECT_ERROR (full_negative, VALIDATION_SEMANTIC)
	RESET (full_negative)
	...
	EXPECT_ERROR (relative1_negative, VALIDATION_SEMANTIC)
	...
	EXPECT_ERROR (relative2_negative, VALIDATION_SEMANTIC)
	...
	EXPECT_ERROR (relative3_negative, VALIDATION_SEMANTIC)
	...
	EXPECT_ERROR (array_negative, VALIDATION_SEMANTIC)
...
static void test_recursive_negative (void)
{
	...
	EXPECT_ERROR (linked_list_negative, VALIDATION_SEMANTIC);
	...
	EXPECT_ERROR (linked_list_negative2, VALIDATION_SEMANTIC);
...
static void test_restriction (void)
{
	...
	EXPECT_ERROR (negative, VALIDATION_SEMANTIC)
	RESET (negative)
	...
	EXPECT_ERROR (empty_negative, VALIDATION_SEMANTIC)
