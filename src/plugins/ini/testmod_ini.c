...
static void test_writeMeta (char * fileName)
{
	...
	KeySet * ks =
		ksNew (30, keyNew ("user:/tests/ini-write/key", KEY_VALUE, "value", KEY_META, "METAKEY", "METAVALUE", KEY_END),
...
static void test_commentDefaultChar (char * fileName)
{
	...
	KeySet * ks = ksNew (30,
			     keyNew ("user:/tests/ini-write/nosectionkey", KEY_VALUE, "nosectionvalue", KEY_META, "comments", "#1",
				     KEY_META, "comments/#0", "nosection comment1", KEY_META, "comments/#1", "nosection comment2", KEY_END),
