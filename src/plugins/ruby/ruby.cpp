...
#define _MODULE_CONFIG_PATH "system:/elektra/modules/" RUBY_PLUGIN_NAME_STR
	if (!strcmp (keyName (parentKey), _MODULE_CONFIG_PATH))
	{
		KeySet * n;
		ksAppend (returned,
			  n = ksNew (30, keyNew (_MODULE_CONFIG_PATH, ELEKTRA_KEY_VALUE, "Ruby plugin", ELEKTRA_KEY_END),
				     keyNew (_MODULE_CONFIG_PATH "/exports", ELEKTRA_KEY_END),
				     keyNew (_MODULE_CONFIG_PATH "/exports/get", ELEKTRA_KEY_FUNC, RUBY_PLUGIN_FUNCTION (Get), ELEKTRA_KEY_END),
				     keyNew (_MODULE_CONFIG_PATH "/exports/set", ELEKTRA_KEY_FUNC, RUBY_PLUGIN_FUNCTION (Set), ELEKTRA_KEY_END),
				     keyNew (_MODULE_CONFIG_PATH "/exports/error", ELEKTRA_KEY_FUNC, RUBY_PLUGIN_FUNCTION (Error), ELEKTRA_KEY_END),
				     keyNew (_MODULE_CONFIG_PATH "/exports/open", ELEKTRA_KEY_FUNC, RUBY_PLUGIN_FUNCTION (Open), ELEKTRA_KEY_END),
				     keyNew (_MODULE_CONFIG_PATH "/exports/close", ELEKTRA_KEY_FUNC, RUBY_PLUGIN_FUNCTION (Close), ELEKTRA_KEY_END),
				     keyNew (_MODULE_CONFIG_PATH "/exports/checkconf", ELEKTRA_KEY_FUNC, RUBY_PLUGIN_FUNCTION (CheckConf), ELEKTRA_KEY_END),
