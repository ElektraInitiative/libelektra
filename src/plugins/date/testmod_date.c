...
{
	ElektraKey * parentKey = elektraKeyNew ("user:/tests/date", ELEKTRA_KEY_VALUE, "", ELEKTRA_KEY_END);
	ElektraKeyset * ks = elektraKeysetNew (5,
			     elektraKeyNew ("user:/tests/date/test", ELEKTRA_KEY_VALUE, date, ELEKTRA_KEY_META, "check/date", "POSIX", ELEKTRA_KEY_META,
...
static void testIso (const char * date, const char * isoString, const short res)
{
	ElektraKey * parentKey = elektraKeyNew ("user:/tests/date", ELEKTRA_KEY_VALUE, "", ELEKTRA_KEY_END);
	ElektraKeyset * ks = elektraKeysetNew (5,
			     elektraKeyNew ("user:/tests/date/test", ELEKTRA_KEY_VALUE, date, ELEKTRA_KEY_META, "check/date", "ISO8601", ELEKTRA_KEY_META,
...
static void testRfc2822 (const char * date, const short res)
{
	ElektraKey * parentKey = elektraKeyNew ("user:/tests/date", ELEKTRA_KEY_VALUE, "", ELEKTRA_KEY_END);
	ElektraKeyset * ks = elektraKeysetNew (5,
			     elektraKeyNew ("user:/tests/date/test", ELEKTRA_KEY_VALUE, date, ELEKTRA_KEY_META, "check/date", "RFC2822", ELEKTRA_KEY_META,
