...
int elektraCalculateOpen(Plugin *handle ELEKTRA_UNUSED, Key *errorKey ELEKTRA_UNUSED)
{
...
int elektraCalculateClose(Plugin *handle ELEKTRA_UNUSED, Key *errorKey ELEKTRA_UNUSED)
{
...
int elektraCalculateGet(Plugin *handle ELEKTRA_UNUSED, KeySet *returned ELEKTRA_UNUSED, Key *parentKey ELEKTRA_UNUSED)
{
	if (!strcmp(keyName(parentKey), "system/elektra/modules/calculate"))
	{
		KeySet *contract = ksNew (30,
				...
				keyNew ("system/elektra/modules/calculate/exports/open",
					KEY_FUNC, elektraCalculateOpen, KEY_END),
				keyNew ("system/elektra/modules/calculate/exports/close",
					KEY_FUNC, elektraCalculateClose, KEY_END),
				...
				keyNew ("system/elektra/modules/calculate/exports/error",
					KEY_FUNC, elektraCalculateError, KEY_END),
...
int elektraCalculateError(Plugin *handle ELEKTRA_UNUSED, KeySet *returned ELEKTRA_UNUSED, Key *parentKey ELEKTRA_UNUSED)
{
	/* set all keys */
...
Plugin *ELEKTRA_PLUGIN_EXPORT(calculate)
{
	return elektraPluginExport("calculate",
			ELEKTRA_PLUGIN_OPEN,	&elektraCalculateOpen,
			ELEKTRA_PLUGIN_CLOSE,	&elektraCalculateClose,
			ELEKTRA_PLUGIN_GET,	&elektraCalculateGet,
			ELEKTRA_PLUGIN_SET,	&elektraCalculateSet,
			ELEKTRA_PLUGIN_ERROR,	&elektraCalculateError,
			ELEKTRA_PLUGIN_END);
}
