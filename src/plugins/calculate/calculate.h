...
int elektraCalculateOpen(Plugin *handle, Key *errorKey);
int elektraCalculateClose(Plugin *handle, Key *errorKey);
...
int elektraCalculateError(Plugin *handle, KeySet *ks, Key *parentKey);
