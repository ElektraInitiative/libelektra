 ...
 * @file
 *
 * @brief Delegate implementation for the `yaypeg` plugin
 *
...
/**
 * @brief This constructor creates a new delegate object used by the `yaypeg` plugin
 *
 * @param config This key set contains configuration values provided by the `yaypeg` plugin
 */
YaypegDelegate::YaypegDelegate (KeySet config)
{
 ...
 *  `yaypeg.cpp` via `delegator::get (handle)->functionName(parameter1, parameter2, …)`.
 *
 ...
 */
kdb::KeySet YaypegDelegate::getConfig (Key const & parent)
{
