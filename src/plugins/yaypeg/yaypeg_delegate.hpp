 ...
 * @file
 *
 * @brief Delegate definitions for the `yaypeg` plugin
 *
 * @copyright BSD License (see LICENSE.md or https://www.libelektra.org)
 *
 */

#ifndef ELEKTRA_CPP_YAYPEG_DELEGATE_HPP
#define ELEKTRA_CPP_YAYPEG_DELEGATE_HPP
...
public:
	explicit YaypegDelegate (KeySet config);
