...
{
	ElektraKey * parentKey = elektraKeyNew ("user:/tests/hexnumber", ELEKTRA_KEY_END);
...
static void test_default (void)
{
	...
	ElektraKeyset * conf = elektraKeysetNew (0, ELEKTRA_KS_END);
	PLUGIN_OPEN ("hexnumber");
	ElektraKeyset * ks = elektraKeysetNew (30, CREATE_TEST_KEY (0xF), CREATE_TEST_KEY (0xf), CREATE_TEST_KEY (0x14), CREATE_TEST_KEY (0xFFFFFFFFFFFFFFFF),
...
{
	ElektraKey * parentKey = elektraKeyNew ("user:/tests/hexnumber", ELEKTRA_KEY_END);
	ElektraKeyset * conf = elektraKeysetNew (10, elektraKeyNew ("system:/accept/type/#0", ELEKTRA_KEY_VALUE, "customint", ELEKTRA_KEY_END),
			       elektraKeyNew ("system:/accept/type/#1", ELEKTRA_KEY_VALUE, "othercustomint", ELEKTRA_KEY_END), ELEKTRA_KS_END);
	PLUGIN_OPEN ("hexnumber");
	ElektraKeyset * ks = elektraKeysetNew (30, CREATE_TEST_KEY_CUSTOM (0x1F, "customint"), CREATE_TEST_KEY_CUSTOM (0xFF, "othercustomint"),
...
static void test_unitbase (void)
{
	...
	ElektraKeyset * conf = elektraKeysetNew (0, ELEKTRA_KS_END);
	PLUGIN_OPEN ("hexnumber");
	ElektraKeyset * ks = elektraKeysetNew (30, CREATE_TEST_KEY_UNITBASE (0x1F), CREATE_TEST_KEY_UNITBASE (0xFF), ELEKTRA_KS_END);
	succeed_if (plugin->kdbGet (plugin, ks, parentKey) >= 1, "call to kdbGet was not successful");
	CHECK_TEST_KEY (0x1F, 31);
	CHECK_TEST_KEY (0xFF, 255);
...
{
	ElektraKey * parentKey = elektraKeyNew ("user:/tests/hexnumber", ELEKTRA_KEY_END);
	ElektraKeyset * conf = elektraKeysetNew (10, elektraKeyNew ("system:/integertypes", ELEKTRA_KEY_VALUE, "customint;othercustomint", ELEKTRA_KEY_END),
			       elektraKeyNew ("system:/force", ELEKTRA_KEY_VALUE, "1", ELEKTRA_KEY_END), ELEKTRA_KS_END);
	PLUGIN_OPEN ("hexnumber");
	ElektraKeyset * ks = elektraKeysetNew (30, CREATE_TEST_KEY_CUSTOM (0x1F, "customint"), CREATE_TEST_KEY_CUSTOM (0xFF, "othercustomint"),
