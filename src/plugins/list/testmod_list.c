...
static void doTest (void)
{
	KeySet * ks = ksNew (5, keyNew ("user/tests/list/to/be/cut/key1", KEY_END), keyNew ("user/tests/list/to/be/cut/key2", KEY_END),
			     ...
			     KS_END);
	KeySet * conf =
		ksNew (20, keyNew ("user/placements", KEY_END), keyNew ("user/placements/get", KEY_VALUE, "pregetstorage", KEY_END),
		       keyNew ("user/placements/set", KEY_VALUE, "presetstorage", KEY_END), keyNew ("user/plugins/#0/config", KEY_END),
		       keyNew ("user/plugins/#0/config/cut", KEY_VALUE, "to/be/cut", KEY_END), keyNew ("user/plugins", KEY_END),
