...
int main (int argc, char const * argv[])
{
	...
	ElektraKeyset * ks = ksNew (5, keyNew ("user:/tests/list/to/be/cut/key1", KEY_END), keyNew ("user:/tests/list/to/be/cut/key2", KEY_END),
			     ...
			     KS_END);
	ElektraKeyset * conf =
		ksNew (20, keyNew ("user:/placements", KEY_END),
	...
	ElektraKeyset * exports = ksNew (0, KS_END);
	ElektraKey * pk = keyNew ("system:/elektra/modules/list", KEY_END);
	...
	ElektraKeyset * delPlugin = ksNew (20, keyNew ("user:/plugins", KEY_END), keyNew ("user:/plugins/#3", KEY_END),
				    keyNew ("user:/plugins/#3/placements", KEY_END),
				    keyNew ("user:/plugins/#3/placements/get", KEY_VALUE, "pregetstorage postgetstorage", KEY_END), KS_END);
