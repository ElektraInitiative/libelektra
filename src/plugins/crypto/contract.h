...
#include ELEKTRA_README (crypto)
	...
	keyNew ("system/elektra/modules/" ELEKTRA_PLUGIN_NAME "/constants/masterpasswordlength", KEY_VALUE,
		ELEKTRA_CRYPTO_DEFAULT_MASTER_PWD_LENGTH, KEY_END),
	keyNew ("system/elektra/modules/" ELEKTRA_PLUGIN_NAME "/constants/iterations", KEY_VALUE, ELEKTRA_CRYPTO_DEFAULT_ITERATION_COUNT,
		KEY_END),
	keyNew ("system/elektra/modules/" ELEKTRA_PLUGIN_NAME "/constants/saltlength", KEY_VALUE, ELEKTRA_CRYPTO_DEFAULT_SALT_LEN, KEY_END),
