...
ksNew (16,
    ...
    keyNew (PREFIX "/array_trailing_comma_1", KEY_META, "array", "#1", KEY_END),
    keyNew (PREFIX "/array_trailing_comma_1/#0", KEY_VALUE, "1", KEY_END),
    keyNew (PREFIX "/array_trailing_comma_1/#1", KEY_VALUE, "2", KEY_END),

    keyNew (PREFIX "/array_trailing_comma_2", KEY_META, "array", "#1", KEY_END),
    keyNew (PREFIX "/array_trailing_comma_2/#0", KEY_VALUE, "1", KEY_END),
    keyNew (PREFIX "/array_trailing_comma_2/#1", KEY_VALUE, "2", KEY_END),
