// clang-format off
elektraKeysetNew (16,
	elektraKeyNew (PREFIX "/multiline_basic_leading_newline",
	...
	ELEKTRA_KEY_END),
	elektraKeyNew (PREFIX "/multiline_basic_lineending_newlines",
	...
	ELEKTRA_KEY_END),
	elektraKeyNew (PREFIX "/multiline_literal_leading_newline",
	...
	ELEKTRA_KEY_END),
	elektraKeyNew (PREFIX "/multiline_literal_linending_newlines",
	...
	ELEKTRA_KEY_END),
	elektraKeyNew (PREFIX "/another_single_ling_string",
	...
	ELEKTRA_KEY_END),
	elektraKeyNew (PREFIX "/multiline_with_terminators",
			ELEKTRA_KEY_VALUE, " ' '' ",
		ELEKTRA_KEY_META, "tomltype", "string_ml_literal",
		ELEKTRA_KEY_META, "type", "string",
