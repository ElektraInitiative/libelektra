...
ksNew (32,
    ...
    keyNew (PREFIX "/basic", KEY_META, "inlinetable", "", KEY_END),
    ...
    keyNew (PREFIX "/inl_with_dot_keys/dot1/dot2", KEY_META, "inlinetable", "", KEY_END),
    ...
    keyNew (PREFIX "/inl_with_array", KEY_META, "inlinetable", "", KEY_END),
    ...
    keyNew (PREFIX "/inl_nested", KEY_META, "inlinetable", "", KEY_END),
    keyNew (PREFIX "/inl_nested/nest_1", KEY_META, "inlinetable", "", KEY_END),
    ...
    keyNew (PREFIX "/inl_nested/nest_2", KEY_META, "inlinetable", "", KEY_END),
    ...
    keyNew (PREFIX "/inl_nested_nested", KEY_META, "inlinetable", "", KEY_END),
    keyNew (PREFIX "/inl_nested_nested/nest_1", KEY_META, "inlinetable", "", KEY_END),
    keyNew (PREFIX "/inl_nested_nested/nest_1/nest_2_1", KEY_META, "inlinetable", "", KEY_END),
    ...
    keyNew (PREFIX "/inl_nested_nested/nest_1/nest_2_2", KEY_META, "inlinetable", "", KEY_END),
