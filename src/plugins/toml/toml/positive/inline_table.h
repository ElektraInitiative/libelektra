...
ksNew (32,
	...
	keyNew (PREFIX "/inl_with_dot_keys/dot1/dot2/a",
		...
		KEY_META, "origvalue",  "\"123\"",
		KEY_META, "order", "5",
	KEY_END),
	keyNew (PREFIX "/inl_with_dot_keys/dot1/dot2/b",
		KEY_VALUE, "456",
		KEY_META, "type", "string",
		KEY_META, "origvalue",  "\"456\"",
		KEY_META, "order", "6",
	KEY_END),
	...
	keyNew (PREFIX "/inl_with_array/str/#0",
		KEY_VALUE, "test1",
		KEY_META, "type", "string",
		KEY_META, "origvalue", "\"test1\"",
	KEY_END),
	keyNew (PREFIX "/inl_with_array/str/#1",
		KEY_VALUE, "test2",
		KEY_META, "type", "string",
		KEY_META, "origvalue", "\"test2\"",
	KEY_END),
