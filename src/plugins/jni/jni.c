...
int elektraJniOpen (Plugin * handle, Key * errorKey)
{
	...
	*/
	...
	if (data->clsPlugin == 0)
	{
		ELEKTRA_SET_INSTALLATION_ERRORF (errorKey, "Cannot find class %s", classname);
		return -1;
	}
	...
	if (data->clsKey == 0)
	{
		ELEKTRA_SET_INSTALLATION_ERROR (errorKey, "Cannot find class Key");
		return -1;
	}
	...
	if (data->clsKeySet == 0)
	{
		ELEKTRA_SET_INSTALLATION_ERROR (errorKey, "Cannot find class KeySet");
		return -1;
	}
	...
	{
		ELEKTRA_SET_INSTALLATION_ERROR (errorKey, "Cannot find constructor of Key");
		return -1;
	}
	...
	{
		ELEKTRA_SET_INSTALLATION_ERROR (errorKey, "Cannot find constructor of KeySet");
		return -1;
	}
	...
	{
		ELEKTRA_SET_INSTALLATION_ERROR (errorKey, "Cannot find release of KeySet");
		return -1;
	}
	...
	{
		ELEKTRA_SET_INSTALLATION_ERROR (errorKey, "Cannot find constructor of plugin");
		return -1;
	}
