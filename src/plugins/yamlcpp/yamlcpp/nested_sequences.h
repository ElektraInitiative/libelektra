...
ksNew (20,
       ...
       keyNew (PREFIX "American Football/#2/American Football (LP2)", KEY_BINARY, KEY_META, "array", "#1", KEY_END),
       ...
       keyNew (PREFIX "Employed To Serve", KEY_BINARY, KEY_META, "array", "#1", KEY_END),
       keyNew (PREFIX "Employed To Serve/#0", KEY_VALUE, "The Warmth Of A Dying Sun", KEY_END),
       keyNew (PREFIX "Employed To Serve/#1", KEY_BINARY, KEY_META, "array", "#0", KEY_END),
       keyNew (PREFIX "Employed To Serve/#1/#0", KEY_VALUE, "Half Life" , KEY_END),
       keyNew (PREFIX "Napalm Death/Apex Predator-Easy Meat", KEY_BINARY, KEY_META, "array", "#2", KEY_END),
