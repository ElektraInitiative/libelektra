...
keyNew("user/tests/yajl/device",
		KEY_END),
keyNew("user/tests/yajl/device/camera",
		KEY_META, "array", "",
		KEY_END),
keyNew("user/tests/yajl/device/camera/#0",
		KEY_META, "array", "",
		KEY_END),
keyNew("user/tests/yajl/device/camera/#0/prefix",
		KEY_VALUE, "EXIF_",
		KEY_END),
keyNew("user/tests/yajl/device/camera/#0/EXIF_model",
		KEY_VALUE, "ShinyGlass", KEY_END),
keyNew("user/tests/yajl/device/camera/#0/EXIF_serial",
		KEY_VALUE, "1200000", KEY_END),
keyNew("user/tests/yajl/device/camera/#0/EXIF_mnft",
		KEY_VALUE, "GLAS", KEY_END),
keyNew("user/tests/yajl/device/camera/#0/EXIF_manufacturer",
		KEY_VALUE, "Glasshuette", KEY_END),
keyNew("user/tests/yajl/device/camera/#0/icc_profile",
		KEY_VALUE, "profile_name.icc",
		KEY_END),
keyNew("user/tests/yajl/device/camera/#0/creation_date",
		KEY_VALUE, "05/08/11 11:59:50",
		KEY_END),
keyNew("user/tests/yajl/device/camera/#0/expire_date",
		KEY_VALUE, "08/08/11 11:59:50",
		KEY_END),
//Typo in example:
//keyNew("user/tests/yajl/device/camera/#0/automatic_assignment",
keyNew("user/tests/yajl/device/camera/#0/automatic_assigment",
		KEY_VALUE, "1", KEY_END),
keyNew("user/tests/yajl/device/camera/#0/comment",
		KEY_VALUE, "nonsense example", KEY_END),

keyNew("user/tests/yajl/device/camera/#1",
		KEY_META, "array", "",
		KEY_END),
keyNew("user/tests/yajl/device/camera/#1/prefix",
		KEY_VALUE, "EXIF_", KEY_END),
keyNew("user/tests/yajl/device/camera/#1/EXIF_model",
		KEY_VALUE, "Knips", KEY_END),
keyNew("user/tests/yajl/device/camera/#1/EXIF_serial",
		KEY_VALUE, "3400000", KEY_END),
keyNew("user/tests/yajl/device/camera/#1/EXIF_mnft",
		KEY_VALUE, "CON", KEY_END),
keyNew("user/tests/yajl/device/camera/#1/EXIF_manufacturer",
		KEY_VALUE, "ConquerLight",
		KEY_END),
keyNew("user/tests/yajl/device/camera/#1/icc_profile",
		KEY_VALUE, "profile_name2.icc",
		KEY_END),
keyNew("user/tests/yajl/device/camera/#1/creation_date",
		KEY_VALUE, "05/08/11 11:59:50",
		KEY_END),
keyNew("user/tests/yajl/device/camera/#1/expire_date",
		KEY_VALUE, "08/08/11 11:59:50",
		KEY_END),
// keyNew("user/tests/yajl/device/camera/#1/automatic_assignment",
keyNew("user/tests/yajl/device/camera/#1/automatic_assigment",
		KEY_VALUE, "1", KEY_END),

keyNew("user/tests/yajl/device/monitor",
		KEY_META, "array", "",
		KEY_END),

keyNew("user/tests/yajl/device/monitor/#0",
		KEY_META, "array", "",
		KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/prefix",
		KEY_VALUE, "EDID_", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_mnft_id",
		KEY_VALUE, "12", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_model_id",
		KEY_VALUE, "123", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_model",
		KEY_VALUE, "LCD1", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_serial",
		KEY_VALUE, "ABCD", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_red_x",
		KEY_VALUE, "0.599609", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_red_y",
		KEY_VALUE, "0.34375", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_green_x",
		KEY_VALUE, "0.320312", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_green_y",
		KEY_VALUE, "0.554688", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_blue_x",
		KEY_VALUE, "0.150391", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_blue_y",
		KEY_VALUE, "0.120117", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_white_x",
		KEY_VALUE, "0.313477", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_white_y",
		KEY_VALUE, "0.329102", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_gamma",
		KEY_VALUE, "2.2", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_mnft",
		KEY_VALUE, "VEN", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_manufacturer",
		KEY_VALUE, "Vendor1", KEY_END),
keyNew("user/tests/yajl/device/monitor/#0/EDID_date",
		KEY_VALUE, "2007-T16", KEY_END),

keyNew("user/tests/yajl/device/monitor/#1",
		KEY_META, "array", "", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/prefix",
		KEY_VALUE, "EDID_", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_mnft_id",
		KEY_VALUE, "34", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_model_id",
		KEY_VALUE, "456", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_model",
		KEY_VALUE, "other monitor", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_serial",
		KEY_VALUE, "other serial", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_red_x",
		KEY_VALUE, "0.599609", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_red_y",
		KEY_VALUE, "0.34375", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_green_x",
		KEY_VALUE, "0.320312", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_green_y",
		KEY_VALUE, "0.554688", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_blue_x",
		KEY_VALUE, "0.150391", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_blue_y",
		KEY_VALUE, "0.120117", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_white_x",
		KEY_VALUE, "0.313477", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_white_y",
		KEY_VALUE, "0.329102", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_gamma",
		KEY_VALUE, "2.2", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_mnft",
		KEY_VALUE, "NEC", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_manufacturer",
		KEY_VALUE, "NEC", KEY_END),
keyNew("user/tests/yajl/device/monitor/#1/EDID_date",
