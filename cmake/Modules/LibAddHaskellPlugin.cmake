							...
							if (GHC_GMP_LIB)
								if (GHC_PRIM_LIB)
									...
									if (ADDTESTING_PHASE AND TARGET elektra-${target})
										...
										get_target_property (HASKELL_RPATH
												     elektra-${target}
												     INSTALL_RPATH)
										get_target_property (SANDBOX_PACKAGEDB
												     elektra-${target}
												     SANDBOX_PACKAGEDB)
...
macro (configure_haskell_sandbox)
	...
	add_custom_command (OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/cabal.sandbox.config"
			    ...
			    COMMAND ${CABAL_EXECUTABLE} sandbox add-source "$CMAKE_SOURCE_DIR/src/bindings/haskell")
