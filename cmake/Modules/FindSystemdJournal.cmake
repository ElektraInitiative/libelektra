...
if (LIBSYSTEMD_JOURNAL_INCLUDE_DIR AND LIBSYSTEMD_ID128_INCLUDE_DIR)
	...
	find_path (LIBSYSTEMD_JOURNAL_INCLUDE_DIR
	...
	find_path (LIBSYSTEMD_ID128_INCLUDE_DIR
		   systemd/sd-id128.h
	...
	find_library (LIBSYSTEMD_JOURNAL_LIBRARIES NAMES systemd PATHS ${_LIBSYSTEMD_PC_LIBDIR})

	# if the merged library was not found try to use the old split library
	if (NOT LIBSYSTEMD_JOURNAL_LIBRARIES)
		find_library (LIBSYSTEMD_JOURNAL_LIBRARIES
			      NAMES systemd-journal
				    systemd-id128
			      PATHS ${_LIBSYSTEMD_JOURNAL_PC_LIBDIR}
