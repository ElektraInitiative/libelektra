function (elektra_export_plugin_symbols)
	...
	file (APPEND ${ARG_HEADER}
		     "extern void libelektra_${ARG_RESOLVER}_LTX_elektraPluginSymbol (void);\n")
	file (APPEND ${ARG_HEADER}
		     "extern void libelektra_${ARG_STORAGE}_LTX_elektraPluginSymbol (void);\n")

	file (WRITE ${ARG_SOURCE}
		    "/* exported_symbols.c generated by exportsymbols.sh */\n\n"
		    "#include <exported_symbols.h>\n\n"
		    "kdblib_symbol kdb_exported_syms[] =\n"
		    "{\n")

	file (APPEND ${ARG_SOURCE}
		     "\t{\"resolver\", 0},\n"
	...
	foreach (PLUGIN ${ARG_PLUGINS})
		file (APPEND ${ARG_HEADER}
			     "extern void libelektra_${PLUGIN}_LTX_elektraPluginSymbol (void);\n")
