...
if (HASKELL_USE_CABAL)
	...
	if (STACK_EXECUTABLE)
		execute_process (COMMAND ${STACK_EXECUTABLE} path --bin-path OUTPUT_VARIABLE STACK_BIN_PATH OUTPUT_STRIP_TRAILING_WHITESPACE
			 WORKING_DIRECTORY ${CMAKE_BINARY_DIR})
		string(REPLACE ":" ";" STACK_BIN_PATH ${STACK_BIN_PATH})
...
set (HASKELL_FOUND 0)
if (HASKELL_USE_CABAL OR STACK_EXECUTABLE)
if (CABAL_EXECUTABLE)
if (C2HS_EXECUTABLE)
if (ALEX_EXECUTABLE)
if (HAPPY_EXECUTABLE)
...
"custom-setup
  setup-depends:
	...
	if (HASKELL_USE_CABAL)
    	...
    	# for stack we don't use a sandbox stack handles that itself
    	# and in case the dependencies haven't been installed properly
    	# it will fail to find e.g. c2hs so this is good to go
    	set (HASKELL_FOUND 1)
    endif (HASKELL_USE_CABAL)
...
else (HASKELL_USE_CABAL OR STACK_EXECUTABLE)
	set (HASKELL_NOTFOUND_INFO "stack not found")
endif (HASKELL_USE_CABAL OR STACK_EXECUTABLE)
