...
set (BINDINGS_LIST_DEFAULT cpp io_uv)
...
list (FIND BINDINGS "IO" FINDEX)
if (FINDEX GREATER -1 OR BINDINGS MATCHES "ALL")
	set(BINDINGS_LIST_IO
		io_uv
		)
	set (BINDINGS_FORCE FORCE)
endif()
...
#
# List of IO-Wrappers to build
#

remember_for_removal(IOBINDINGS TO_REMOVE_IOBINDINGS)

set (IOBINDINGS_LIST_DEFAULT "")

if (IOBINDINGS MATCHES "DEFAULT")
	set (IOBINDINGS_FORCE FORCE)
endif ()

if (IOBINDINGS MATCHES "ALL")
	set (IOBINDINGS_LIST
		uv
		)
	set (IOBINDINGS_FORCE FORCE)
	list (REMOVE_ITEM IOBINDINGS ALL)
endif ()

set (IOBINDINGS_DOC "Which IOBINDINGS should be added? ALL for all available, DEFAULT for minimal set.")

set (IOBINDINGS
	${IOBINDINGS_LIST_DEFAULT}
	${IOBINDINGS_LIST}
	${IOBINDINGS}
	CACHE STRING ${IOBINDINGS_DOC}
	${IOBINDINGS_FORCE}
	)

removal(IOBINDINGS TO_REMOVE_IOBINDINGS)
set(IOBINDINGS ${IOBINDINGS} CACHE STRING ${TOOLS_DOC} FORCE)
