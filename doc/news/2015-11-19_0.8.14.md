...
- [on github](https://libelektra.org/blob/master/doc/help/kdb.md)
...
- [Design decisions](https://libelektra.org/blob/master/doc/decisions)
...
[the lua plugin](https://libelektra.org/blob/master/src/plugins/lua/).
In a similar way, someone can write scripts, which are executed on every
access to the
[key database](https://libelektra.org/blob/master/doc/help/elektra-glossary.md).
...
[demonstrates how a plugin](https://libelektra.org/blob/master/src/plugins/crypto/)
...
For details [see the documentation](https://libelektra.org/blob/master/src/plugins/mathcheck/).
...
For details [see the documentation](https://libelektra.org/blob/master/src/plugins/conditionals/).
...
For details [see the documentation](https://libelektra.org/blob/master/src/plugins/csvstorage/).
...
- fix glob plugin + kdb mount with
  [config/needs usage](https://libelektra.org/blob/master/doc/help/elektra-contracts.md)
...
[elektrify-getenv](https://libelektra.org/blob/master/src/libs/getenv/README.md)
enabled.
