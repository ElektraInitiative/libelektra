...
the new [codes](../decisions/6_implemented/error_codes.md). This allows us to easily extend the specification without breaking existing
...
- [about error codes](../decisions/6_implemented/error_codes.md)
- [about error message format](../decisions/6_implemented/error_message_format.md)
...
- signifies arrays with the metakey array according to the [array decision](../decisions/5_partially_implemented/array.md). _(Philipp Gackstatter)_
...
- YAMBi now supports Elektra’s [boolean data type](../decisions/5_partially_implemented/boolean.md). _(René Schwaiger)_
...
- [YAML CPP][] now handles the conversion from and to [Elektra’s boolean type](../decisions/5_partially_implemented/boolean.md) properly. _(René Schwaiger)_
...
- [Yan LR](https://www.libelektra.org/plugins/yanlr) now supports Elektra’s [boolean data type](../decisions/5_partially_implemented/boolean.md). _(René Schwaiger)_
...
- The plugin now supports Elektra’s [boolean data type](../decisions/5_partially_implemented/boolean.md). _(René Schwaiger)_
...
- Drastically improved the error message format. For more information look [here](../../doc/decisions/6_implemented/error_message_format.md). _(Michael Zronek)_
