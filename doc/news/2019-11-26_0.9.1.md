...
- shortDesc: KDE Integration, 3-way Merge, Code Generation
...
- We migrated our [build server](https://build.libelektra.org) to up-to-date hardware. _(Markus Raab and Djordje Bulatovic)_
...
- Elektrify KDE _(Dardan Haxhimustafa and Felix Resch)_
- Elektrify LCDproc _(Klemens Böswirth)_ and _(Jakob Fischer)_
- Merge tool in C99 to supersede the existing merge tool. The goal is to reduce the number of merge conflicts in contrast to regular merge tools using the specific semantics of configuration files. _(Dominic Jäger)_
