...
- Elektra now has a technical preview of a new [merge library](../tutorials/merge.md). It is written in C99 and can currently be used with [`kdb merge`](../help/kdb-merge.md). _(Dominic Jäger)_
