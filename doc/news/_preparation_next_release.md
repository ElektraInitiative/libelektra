...
randomized hash map and is very effective for static configurations. The OPMPHM
can be enabled for a search by passing `KDB_O_OPMPHM` as option to the lookup.
