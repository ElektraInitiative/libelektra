...
<<`scripts/git-release-stats 0.8.23`>>
...
Different to other UIs, it generates its interface according specifications of the configuration
settings as available via Elektra.

For example, if a configuration setting only has some choices, you get exactly these choices
