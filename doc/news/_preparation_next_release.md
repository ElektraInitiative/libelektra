...
- The new script [reformat-java](../../scripts/dev/reformat-java) formats the Java code in the repository using [`clang-format`](https://clang.llvm.org/docs/ClangFormat.html). _(René Schwaiger)_
