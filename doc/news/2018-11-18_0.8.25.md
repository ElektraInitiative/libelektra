...
- The command [`reformat-source`](https://master.libelektra.org/scripts/dev/reformat-markdown) now displays information about the installed
...
- The new command [`reformat-shfmt`][https://master.libelektra.org/scripts/dev/reformat-shfmt] reformats Shell scripts using the tool [`shfmt`](https://github.com/mvdan/sh). _(René Schwaiger)_
...
- We restructured the code of the [CMake module](https://master.libelektra.org/scripts/cmake/Modules/FindHaskell.cmake) we use to detect Haskell
