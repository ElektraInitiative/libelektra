...
<<`scripts/git-release-stats 0.9.VER-1 0.9.0`>>
...
- [here](https://www.libelektra.org/ftp/elektra/releases/elektra-0.9.0.tar.gz) or
- [GitHub](https://github.com/ElektraInitiative/ftp/blob/master/releases/elektra-0.9.0.tar.gz?raw=true)

The [hashsums are:](https://github.com/ElektraInitiative/ftp/blob/master/releases/elektra-0.9.0.tar.gz.hashsum?raw=true)

<<`scripts/generate-hashsums elektra-0.9.0.tar.gz`>>

The release tarball is also available signed using GnuPG from

- [here](https://www.libelektra.org/ftp/elektra/releases/elektra-0.9.0.tar.gz.gpg) or
...
- [here](https://doc.libelektra.org/api/0.9.0/html/) or
- [GitHub](https://github.com/ElektraInitiative/doc/tree/master/api/0.9.0).
