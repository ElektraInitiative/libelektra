...
It considers mountpoints and also takes bookmarks into account. Thanks to
Armin Wurzinger for creating this useful utility. Our Zsh and fish completions
...
- [fcrypt plugin](https://www.libelektra.org/plugins/fcrypt):
  major improvements, the plugin now list available GPG keys when config is missing,
