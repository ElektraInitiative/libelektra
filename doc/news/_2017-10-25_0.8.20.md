...
Thus now our community server is completely managed by libelektra.
...
exclusively in Haskell, without any glue code. Several Haskell [examples](https://master.libelektra.org/src/bindings/haskell/examples)
