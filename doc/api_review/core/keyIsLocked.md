...
- [ ] `@param` for every parameter - [ ] add
- [ ] `@return` / `@retval` - [ ] change default case to `@return`
- [ ] `@since` - [ ] add
- [x] `@ingroup`
- [ ] `@see` - [ ] move to bottom
...
- [ ] All possible error states are covered by tests - [ ] test for null pointer return value
