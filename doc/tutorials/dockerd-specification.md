...
You can define the path inside the `spec:/` namespace as `/sw/dockerd/dockerd/#0/current`, refer to
...
```sh
sudo kdb mount ~/.config/dockerd/dockerd-daemon.ni spec:/sw/dockerd/dockerd/#0/current ni
```
...
```sh
cat $(kdb file spec:/sw/dockerd/dockerd/#0/current)
...
kdb file user:/sw/dockerd/dockerd/#0/current
# /home/user/.config/daemon.ni

kdb file dir:/sw/dockerd/dockerd/#0/current
...
kdb meta-set spec:/sw/dockerd/dockerd/#0/current/data/root description "Root directory of persistent Docker state"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/data/root default "/var/lib/docker"
```
...
```sh
kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/cgroupns/mode description "Default mode for containers cgroup namespace"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/cgroupns/mode default "private"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/cgroupns/mode check/enum "#1"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/cgroupns/mode check/enum/#0 "host"
...
```sh
kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/ulimits/_ type "long"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/ulimits/_ description "Default ulimits for containers"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/ulimits/_ example "64000"
```
...
```sh
kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/address/pools array/min "0"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/address/pools description "Default address pools for node specific local networks (list)"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/address/pools/#/base type "string"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/address/pools/#/base description "Ip address (ipv4) + subnet"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/address/pools/#/base example "172.30.0.0/16"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/address/pools/#/size type "short"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/address/pools/#/size description "Number of ip addresses in this pool with base"

kdb meta-set spec:/sw/dockerd/dockerd/#0/current/default/address/pools/#/size example "24"
```
