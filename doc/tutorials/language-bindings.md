...
Since v0.9.0, Elektra has a new error code system. You might want to take a look in the [design decision](../decisions/6_implemented/error_codes.md)
...
All error codes as well as the hierarchy itself is depicted in the [design decision](../decisions/6_implemented/error_codes.md).
...
In Elektra every error has a predefined format. You can take a look at the [related design decision](../decisions/6_implemented/error_message_format.md)
