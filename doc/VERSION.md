...
- the API for programs using Elektra. Its interface
  is declared in [src/include/kdb.h](/src/include/elektra/kdb.h).
  Both applications and plugins use this API.
- the high-level API as declared in
  [src/include/elektra.h](/src/include/elektra/highlevel.h).
- the API to plugins as declared in
  [src/plugins/doc/doc.h](/src/plugins/doc/doc.h).
- the API to [libease](/src/include/elektra/ease.h)
- the API to [libmerge](/src/include/elektra/merge.h)
- the API to [module loading](/src/include/internal/pluginload/module.h)
- the API to [libnotification](/src/include/elektra/notifications.h)
- the API to [libopts](/src/include/elektra/opts.h)
