...
Possible copy-on-write implementations are described in [another decision](../5_implemented/copy_on_write.md).
...
- Before we can implement this decision, we need to implement the [copy-on-write decision](../5_implemented/copy_on_write.md).
...
- [Copy On Write](../5_implemented/copy_on_write.md)
