...
- _Remove_/_Change_ all functions related to (binary) key values as described in ([`Key` value types](../0_drafts/key_value_types.md))
...
- [Binary](../0_drafts/key_value_types.md)
