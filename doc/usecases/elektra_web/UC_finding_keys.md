...
Main success scenario: User searches for a key by entering information (its path or metadata) in a field. The whole key database is filtered according to the contents of the search field.
