...
- [ ] umount via path (makes merge script easier)
...
- [ ] the evaluation about a dpkg patch
- [ ] the merging framework and its strategies
...
- [ ] provide Elektra debian packages for the new version 
